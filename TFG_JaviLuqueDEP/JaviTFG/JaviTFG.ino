		...
		switch (m.estado) {
		    case PREGUNTA:		      
              ...
              if(m.estado != m.estadoB){
                m.R = random(1, 100);  //Posibilidad de descarga.
              }
          ...
          m.estado = PREGUNTA;
		    ...
		    case INDIRECTO:		      		      
		      if(m.R < PROBABILIDAD && currms - m.cambioms >= tms && m.boom==0){
		          Descarga();
              m.boom = 1;
		      }
